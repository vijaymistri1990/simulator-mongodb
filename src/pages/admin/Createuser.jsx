    ...
    <div className="mt-2">
      <LegacyCard>
        ...
        <div className="p-2 mx-2">
          <div className="py-2 fs-3 text-center">
            <h1> {state ? "Edit" : "Create"} User</h1>
          </div>
          ...
          <div className="row justify-content-center">
            <div className="col-sm-6 mt-3 text-end">
              <div className="sl-add-button pb-5">
                {state && (
                  <span className="px-2">
                    <Button onClick={() => handleEditPassword(state)}>
                      Update Password
                    </Button>
                  </span>
                )}
                <Button onClick={formik.handleSubmit} loading={loader}>
                  {state ? "Edit" : "Save"}
                </Button>
              </div>
            </div>
